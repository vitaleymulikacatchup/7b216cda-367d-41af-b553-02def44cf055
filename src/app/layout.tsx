...
export const metadata: Metadata = {
  title: "My Dog - Premium Dog Care & Training Guide",
  description: "Complete dog care guide with training tips, health advice, and wellness resources for happy, healthy dogs. Expert guidance for dog owners.",
  keywords: "dog care, dog training, dog health, pet wellness, dog tips",
  metadataBase: new URL("https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1764335478938-ypwyv8hb.jpg"),
  alternates: {
    canonical: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1764335478938-ypwyv8hb.jpg"
  },
  openGraph: {
    title: "My Dog - Premium Dog Care & Training Guide",
    description: "Complete dog care guide with training tips, health advice, and wellness resources for happy, healthy dogs",
    siteName: "My Dog",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1764335478938-ypwyv8hb.jpg",
      alt: "Happy dog"
    }]
  },
  twitter: {
    ...
    title: "My Dog - Premium Dog Care & Training Guide",
    description: "Complete dog care guide with training tips, health advice, and wellness resources",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1764335478938-ypwyv8hb.jpg"]
  }
};
